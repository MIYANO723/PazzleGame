...
window.onload = function(){
	...
	game.fps = 16;
	game.preload('puzzle.png','http://enchantjs.com/assets/images/charal.gif','http://enchantjs.com/assets/images/map0.gif','http://enchantjs.com/assets/      images/icon0.gif');
